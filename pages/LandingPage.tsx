        ...
        <div className="min-h-screen bg-brandLight font-sans text-gray-800">
            ...
            <footer className="bg-brandDark text-brandLight py-16">
                <div className="container mx-auto px-4 max-w-6xl">
                    ...
                    <div className="mt-16 pt-8 border-t border-white/5 text-center text-sm opacity-50 flex flex-col items-center gap-2">
                        <p>&copy; {new Date().getFullYear()} Centro Médico VillaMed. Todos os direitos reservados.</p>
                        <a href="/admin/login" className="hover:text-primary transition-colors text-[10px] uppercase tracking-widest">Acesso Restrito</a>
                    </div>
                </div>
            </footer>
